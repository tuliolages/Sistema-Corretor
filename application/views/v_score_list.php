...
<?php if ($this->datahandler->is_now_between_time($list['data_inicio_revisao'], $list['data_fim_revisao'])) { ?>
...
<table class='score'><tr><td class='login'><?=$user['login']?></td>
	<?php $is_cheating = $this->submissions->has_invalid_for_problems($problems, $user['login']);
